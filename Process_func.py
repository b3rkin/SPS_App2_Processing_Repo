...
def merge_based_router():
    """
    Merge the obtained pmfs for three different datafiles all corresponding to one router
    """


    df1 = pd.read_csv("MACpmf/d0_4d_c6_f3_02_41.csv")
    df2 = pd.read_csv("MACpmf/d0_4d_c6_f3_02_42.csv")

    # df1 = pd.DataFrame({'A': [5, 0], 'B': [2, 4]})
    # df2 = pd.DataFrame({'A': [1, 1], 'B': [3, 3]})
    # df1.combine(df2, np.add)
    print(df1.combine(df2, np.add))
